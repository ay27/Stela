/* @ts-self-types="./argus_redact_wasm.d.ts" */
...
export class StreamingRedactor {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        StreamingRedactorFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_streamingredactor_free(ptr, 0);
    }
    /**
    ...
    feed(chunk) {
        try {
            ...
            wasm.streamingredactor_feed(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    flush() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.streamingredactor_flush(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    constructor(opts) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.streamingredactor_new(retptr, addHeapObject(opts));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            this.__wbg_ptr = r0;
            StreamingRedactorFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
...
if (Symbol.dispose) StreamingRedactor.prototype[Symbol.dispose] = StreamingRedactor.prototype.free;
...
export function redact(text, opts) {
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.redact(retptr, ptr0, len0, addHeapObject(opts));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {string}
 */
export function restore(text, key, aliases) {
    let deferred3_0;
    let deferred3_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.restore(retptr, ptr0, len0, addHeapObject(key), addHeapObject(aliases));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
 ...
 * @returns {any}
 */
export function restore_guarded(text, key, anchor, aliases) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.restore_guarded(retptr, ptr0, len0, addHeapObject(key), addHeapObject(anchor), addHeapObject(aliases));
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./argus_redact_wasm_bg.js": import0,
    };
}

const StreamingRedactorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_streamingredactor_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('argus_redact_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
