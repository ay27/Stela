...
export function buildSystemPrompt(
  ...
  return [
    ...
    "A persistent chart uses a fenced ```stela-chart``` JSON block immediately after its runsql source. When saving a chart to a note, use propose_edit, preserve all existing content, append the executed SQL as runsql without a fabricated <detail>, and change the chart source to {\"kind\":\"previous-runsql\",\"fallbackRunId\":\"the validated runId\"}.",
