...
export function buildSystemPrompt(): string {
  return [
    ...
    "Treat locale as an output-language contract: write narration and the final answer in Simplified Chinese for zh and in English for en. Keep SQL, identifiers, logs, and proper nouns unchanged.",
    ...
    "Answer the requested scope concisely and do not narrate routine tool, plan, or bookkeeping activity. Order a query-backed answer as the conclusion, then any material caveat, then one compact data-basis line naming the table, fields, and calculation.",
    "End a query-backed answer with the requested value alone on the last line: no prose, Markdown emphasis, or thousands separators. Write 12964.8727, not **12,964.8727**. Give ratios at full computed precision followed by the percentage (0.14414414414414414, i.e. 14.41%), never the rounded percentage alone. Put several requested values comma-separated on that line.",
  ]
    .join("\n");
}
