...
export function buildSystemPrompt(
  ...
  return [
    ...
    "When the user answers a question that defines a metric or column meaning, offer to persist it with propose_edit — append it under a stable section heading in the relevant note (e.g. `## 口径`) so the definition is findable next time. Don't write it without approval.",
