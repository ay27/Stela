...
import { analysisCanvasSqlIssue, createAnalysisCanvas, readAnalysisCanvas, updateAnalysisCanvas, updateAnalysisCanvasFlowLayout } from "./analysis-canvas";
...
try {
  ...
  const withFlow = await updateAnalysisCanvas(root, created.path, withSource.etag, (value) => ({
    ...value,
