...
export const IPC = {
  ...
  AI_PYTHON_RUNTIME_SEMANTIC: "ai:python-runtime-semantic",
  AI_PYTHON_WORKSPACE_LOST: "ai:python-workspace-lost",
  AI_PYTHON_WORKSPACE_STATUS: "ai:python-workspace-status",
  AI_PYTHON_WORKSPACE_RESET: "ai:python-workspace-reset",
  AI_SEMANTIC_REVOKE: "ai:semantic-revoke",
