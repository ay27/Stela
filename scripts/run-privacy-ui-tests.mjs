...
const dir = "out/tests/privacy-ui";
await mkdir(dir, { recursive: true });
await build({ entryPoints: ["scripts/tests/privacy-ui-main.ts"], outfile: `${dir}/main.mjs`, bundle: true, platform: "node", format: "esm", packages: "external" });
await build({ entryPoints: ["scripts/tests/privacy-ui-renderer.tsx"], outfile: `${dir}/renderer.js`, bundle: true, platform: "browser", format: "iife", external: ["node:*", "pyodide"], define: { "process.env.NODE_ENV": '"production"', "import.meta.env": "{}" }, logLevel: "warning" });
